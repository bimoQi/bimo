...
class Page{
    ...
    public function show() {
        ...
        $up_page = $up_row > 0 ? '<li class="pre"><a  href="' . $this->url($up_row) . '">' . $this->config['prev'] . '</a></li>' : '';

        //下一页
        $down_row  = $this->nowPage + 1;
        $down_page = ($down_row <= $this->totalPages) ? '<li class="pre"><a href="' . $this->url($down_row) . '">' . $this->config['next'] . '</a></li>' : '';
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page > 0 && $this->totalPages != 1){
                    $link_page .= '<li id="active" class="active"><a> ' . $page . '</a></li>';
                }
            }
        }
